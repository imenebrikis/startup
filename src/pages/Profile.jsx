...
export default function Profile() {
  ...
  if (loading)
    return (
      <div style={{ padding: "48px", textAlign: "center" }}>Chargement...</div>
    );
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            {navLinks.map(({ to, icon, label }) => (
              <Link
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#F7F7EC")
                }
                onMouseLeave={(e) =>
              ...
              {isEditing ? (
                ...
                <>
                  ...
                  >
                    ...
                    {profile?.quartier || ""} , {profile?.wilaya || "Algérie"}
                  </div>
                  <div
                    style={{
                      display: "flex",
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    borderBottom:
                      activeTab === id ? "2px solid #4B3FD8" : "none",
                    cursor: "pointer",
                  }}
                >
                  {label}
                        ...
                        >
                          <span
                            style={{
                              padding: "6px 12px",
                              borderRadius: "100px",
                              background: listing.is_for_exchange
                                ? "#F7F7EC"
                                : "#EEF2FF",
                              color: listing.is_for_exchange
                                ? "#0A3D3D"
                                : "#4B3FD8",
                              fontSize: "12px",
                              fontWeight: "600",
