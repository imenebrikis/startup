  ...
  const handleLogin = async (e) => {
    ...
    if (signInError) {
      if (signInError.message.includes("Email not confirmed")) {
        ...
        setError("Incorrect email/password, or unverified email.");
      }
      setLoading(false);
      return;
    }
